//-----------------------------
// Fit spatial factor analysis or (spatial LVM)
// Results for the restricted spatial factor analysis or RSFA are also obtained from this as a straightforward byproduct.
